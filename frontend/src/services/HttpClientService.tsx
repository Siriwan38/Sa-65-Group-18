...
async function GetBorrowList() {
  ...
  let res = await fetch(`${apiUrl}/borrowlist`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function GetEmployeeLogIn() {
  const requestOptions = {
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
...
async function BorrowLists(data: BorrowListInterface) {
  const requestOptions = {
    method: "POST",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  let res = await fetch(`${apiUrl}/createborrowlist`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
